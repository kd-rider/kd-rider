...
import 'package:tuktuk_toto/AllScreens/registrationScreen.dart';
...
class LoginScreen extends StatelessWidget {
  ...
  void loginAndAuthenticateUser(BuildContext context) async
  {
    ...
    ).then((value) {firebaseUser=value.user;}).catchError((errMsg){
    ...
    {
      print("inside ===== ");
      print("===>" + usersRef.get().toString());
      print(await usersRef.child(firebaseUser?.uid??"").once().toString());
